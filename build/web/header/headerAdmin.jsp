<%-- 
    ...
    Created on : Oct 24, 2023, 10:58:10 AM
    Author     : Admin
--%>
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <%
                        if(acc != null){                               
                            ...
                            Account getAcc = accountDB.getProducts(acc);
                            String img = getAcc.getImage().isEmpty() ? "https://www.lottemart.vn/asset/images/icon-default-avatar.svg" : getAcc.getImage();
                            out.print("<img src='" + img + "' alt='' class='rounded-circle'>");
                        }
                    %>
        ...
        <%
            ...
            if(acc!= null){
                ...
                if(rtAcc.getRole().equals("")){
                    flag = rtAcc.getRole().equals("");
                } else {
                    flag = rtAcc.getRole().equals("admin");
                } 
            }                       
        %>
        <c:if test="<%=flag%>">
...
<script>
    const navLink = document.querySelector(".sidebar-nav").querySelectorAll('.nav-link');
